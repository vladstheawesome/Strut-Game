...
public class RPGCameraEditor : Editor {
	...
	public override void OnInspectorGUI() {
		...
		if (_showGeneralSettings) {
			...
			script.RotateWithCharacter = (RotateWithCharacter)EditorGUILayout.EnumPopup("Rotate With Character", script.RotateWithCharacter);
			script.RotationStoppingInput = EditorGUILayout.TextField("Rotation Stopping Input", script.RotationStoppingInput);
			script.UnderwaterFogColor = EditorGUILayout.ColorField("Underwater Fog Color", script.UnderwaterFogColor);
			script.UnderwaterFogDensity = EditorGUILayout.FloatField("Underwater Fog Density", script.UnderwaterFogDensity);
		}
		...
		if (_showDistanceSettings) {			
			script.StartDistance = EditorGUILayout.FloatField("Start Distance", script.StartDistance);
			script.MinDistance = EditorGUILayout.FloatField("Min Distance", script.MinDistance);
		...
		if (_showAlignmentSettings) {
			...
			script.AlignCharacterInput = EditorGUILayout.TextField("Align Character Input", script.AlignCharacterInput);
			script.AlignCharacterSpeed = EditorGUILayout.FloatField("Align Character Speed", script.AlignCharacterSpeed);
